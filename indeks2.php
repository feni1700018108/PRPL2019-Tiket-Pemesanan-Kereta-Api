    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="id_pesan" type="text" class="validate" name="id_pesan">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="atas_nama" type="text" class="validate" name="atas_nama">
                <label for="atas_nama">Atas Nama</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="usia" type="text" class="validate" name="usia">
                <label for="usia">Usia</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="no_kk" type="text" class="validate" name="no_kk">
                <label for="no_kk">No KK</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="no_hp" type="text" class="validate" name="no_hp">
                <label for="no_hp">No HP</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="tgl_pesan" type="datetime" class="validate" name="tgl_pesan">
                <label for="tgl_pesan">Tanggal Pemesanan</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="jml_penumpang" type="text" class="validate" name="jml_penumpang">
...
<div id="modal-transaksi" class="modal" style="width:500px">
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="input-field col r3">
                <input id="tot_bayar" type="text" class="validate" name="tot_bayar" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="tot_bayar">Total Bayar</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col r3">
                <input id="diskon" type="text" class="validate" name="diskon" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="diskon">Diskon</label>
            </div>
            <div class="input-field col r3">
                <input id="tot_setdiskon" type="text" class="validate" name="tot_setdiskon" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="tot_setdiskon">Total Setelah Diskon</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col r3">
                <input id="bayar" type="text" class="validate" name="bayar" onfocus="mulaiHitung()" onblur="berhentiHitung()" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="bayar">Bayar</label>
            </div>
            <div class="input-field col r3">
                <input id="kembalian" type="text" class="validate" name="kembalian" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
